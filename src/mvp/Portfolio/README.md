...
- **X:** UTC-5 midnight, `2020-08-01` .. `2026-09-19` inclusive; full daily walk is randomly subsampled to **100** points (first and last dates always kept).
- **Y:** integer USDT `2000..5000`, seeded random per day.
