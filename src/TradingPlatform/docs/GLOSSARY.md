...
| Term | Meaning |
|------|---------|
| **SeriesDescriptor** | Logical candle stream: symbol + `TimeFrameCode` (e.g. BTCUSDT + `1m`). |
| **TimeFrameCode** | Chart-style token: lowercase **s** / **m** (e.g. `1s`, `1m`, `15m`); uppercase **H** / **D** / **W** / **M** (e.g. `1H`, `1D`, `1M`). **1m** = minute, **1M** = month. |
| **Trading vector** | `TradingVectorSpec`: symbol, timeframe, position side, strategy kind, parameters, stable `TradingVectorId`. |
