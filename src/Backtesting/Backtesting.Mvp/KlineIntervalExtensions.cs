...
internal static class KlineIntervalExtensions
{
    ...
    /// <summary>Approximate number of bars per year for annualizing Sharpe.</summary>
    public static double BarsPerYear(this KlineInterval interval)
    {
        var seconds = interval.ToSeconds();
        var barsPerDay = 86_400d / seconds;
        return barsPerDay * 365.25;
    }
}
