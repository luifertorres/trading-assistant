...
#### Scenario: Indicators calculated on validated candle close

- **WHEN** a closed candle is received from the Candlestick Data API for a symbol and timeframe with integrity status `Eligible`
- **THEN** the indicator calculation pipeline calculates RSI and SMA values for configured lengths
