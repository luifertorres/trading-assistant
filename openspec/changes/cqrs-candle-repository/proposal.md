...
- Delegate 1m closed-candle websocket ingestion to this API so one service owns market-data continuity and normalization.
...
- Integration impact: main app will call this API via REST client during startup and continue initialization asynchronously.
