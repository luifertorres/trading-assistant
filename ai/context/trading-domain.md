...
- **TradingPlatform terms and bounded contexts:** [src/platform/TradingPlatform/docs/GLOSSARY.md](../../src/platform/TradingPlatform/docs/GLOSSARY.md) (e.g. `SeriesDescriptor`, `TimeFrameCode`, `TradingVector`, broker ACL).
